...
export default function Home() {
  ...
  return (
    <div className={darkModeToggle ? "dark bg-black" : ""} >
      ...
      <div className="text-right fixed top-0 right-0 p-2 pt-6 rounded">
        <Button className={darkModeToggle && "dark"}
      ...
      <div  className={darkModeToggle ? "dark bg-black text-white py-1 pb-4" : "py-1 pb-4"} >
        <a href="https://learnzo.online" target='_blank' className="opacity-50 hover:opacity-100 duration-200">openv0 <span className="text-xs">by Arnab</span></a> <a className="opacity-50 text-xs hover:opacity-80 duration-200" target='_blank' href="https://v0.dev">&nbsp;/ an open source tool inspired by v0.dev, based on shadcn + lucide</a>
      </div>
