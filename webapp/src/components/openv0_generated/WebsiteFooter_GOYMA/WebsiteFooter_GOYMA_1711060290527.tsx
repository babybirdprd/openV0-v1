...
export default function WebsiteFooter_GOYMA() {
  return (
    <footer className="bg-black text-white p-12 space-y-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-10 gap-y-8">
        <div>
          <Avatar>
        ...
        <div className="space-y-4">
          ...
          <form className="flex flex-col gap-4">
            <Input type="email" className="rounded dark:bg-gray-800 placeholder-gray-500 text-white" placeholder="Email Address" />
      ...
      <div className="max-w-7xl mx-auto text-center text-gray-500 space-y-4">
