    ...
    <div className="max-w-3xl mx-auto p-4">
      <Tabs defaultValue="getting-started" className="bg-white dark:bg-black rounded-md shadow-lg">
        <TabsList className="flex space-x-4 my-4">
          <TabsTrigger value="getting-started" className="p-2 rounded-md bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 hover:bg-gray-300 cursor-pointer">Getting Started</TabsTrigger>
          <TabsTrigger value="features" className="p-2 rounded-md bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 hover:bg-gray-300 cursor-pointer">Features</TabsTrigger>
          <TabsTrigger value="faq" className="p-2 rounded-md bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 hover:bg-gray-300 cursor-pointer">FAQ</TabsTrigger>
        </TabsList>
