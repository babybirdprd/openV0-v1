    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div
          ...
          style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80")' }}
        ></div>
        <div className="absolute inset-0 bg-black opacity-50 dark:bg-black"></div>
      </div>
      {/* Contact form */}
