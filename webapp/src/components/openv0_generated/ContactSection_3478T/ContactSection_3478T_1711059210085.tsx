  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute top-0 left-0 z-10 flex h-full w-full items-center justify-center lg:justify-start p-4 lg:p-12">
        <Card className="max-w-md bg-white/90 dark:bg-black/90 backdrop-blur-sm shadow-lg rounded-lg">
          <CardContent>
          ...
          <CardFooter className="flex justify-end">
            <Button className="mt-4 bg-blue-500 text-white dark:bg-blue-400 dark:text-black hover:bg-blue-600 dark:hover:bg-blue-500">Send Message</Button>
          </CardFooter>
        </Card>
      </div>
    </div>
