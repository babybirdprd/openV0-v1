...
const PricingSection_DCYFJ: React.FC = () => {
  return (
    <section className="md:flex md:justify-between space-y-10 md:space-y-0 md:space-x-10 py-8 px-4 bg-white dark:bg-black rounded-lg shadow-lg">
      <Card className="flex flex-col m-5 md:w-1/3 bg-blue-100 dark:bg-gray-800 p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-500 ease-in-out">
        <CardHeader>
      ...
      <Card className="flex flex-col m-5 md:w-1/3 bg-yellow-100 dark:bg-gray-800 p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-500 ease-in-out">
        <CardHeader>
        ...
        <CardFooter className="mt-auto">
          <Button variant="solid" className="w-full bg-yellow-600 text-black hover:bg-yellow-700 transition-colors duration-300 ease-in-out">Subscribe</Button>
        </CardFooter>
      </Card>

      <Card className="flex flex-col m-5 md:w-1/3 bg-gray-100 dark:bg-gray-800 p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-500 ease-in-out">
        <CardHeader>
        ...
        <CardFooter className="mt-auto">
          <Button variant="solid" className="w-full bg-green-600 text-black hover:bg-green-700 transition-colors duration-300 ease-in-out">Subscribe</Button>
        </CardFooter>
      </Card>
    </section>
  );
